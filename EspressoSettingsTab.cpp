...
: m_parent(parent)
{
	...
	static lv_coord_t grid1_col_dsc[] = {LV_GRID_CONTENT, LV_GRID_TEMPLATE_LAST};
	static lv_coord_t grid1_row_dsc[] = {LV_GRID_CONTENT, LV_GRID_CONTENT, LV_GRID_TEMPLATE_LAST};
	lv_obj_set_grid_dsc_array(parent, grid1_col_dsc, grid1_row_dsc);
